 ...
 */
class ApplicationServerInfoData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServerInfoData';
    ...
    protected static $openAPITypes = [
        ...
        'fully_synched' => 'bool',
        'sync_status' => '\OpenAPI\Client\Model\ApplicationServerInfoSyncStatusData[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('onion', $data ?? [], null);
        $this->setIfExists('supported_payment_methods', $data ?? [], null);
        $this->setIfExists('fully_synched', $data ?? [], null);
    ...
    */
     ...
     * Sets version
     *
     * @param string|null $version BTCPay Server version
     *
     * @return self
     */
     ...
     * Sets onion
     *
     * @param string|null $onion The Tor hostname
     *
     * @return self
     */
    ...
    {
        if (is_null($onion)) {
            throw new \InvalidArgumentException('non-nullable onion cannot be null');
        }
     ...
     *
     * @param string[]|null $supported_payment_methods The payment methods this server supports
     *
     * @return self
     */
     ...
     * Sets fully_synched
     *
     * @param bool|null $fully_synched True if the instance is fully synchronized, according to NBXplorer
     *
     * @return self
     */
    public function setFullySynched($fully_synched)
    {
        if (is_null($fully_synched)) {
            throw new \InvalidArgumentException('non-nullable fully_synched cannot be null');
        }
     ...
     * Gets sync_status
     *
     * @return \OpenAPI\Client\Model\ApplicationServerInfoSyncStatusData[]|null
     */
     ...
     * Sets sync_status
     *
     * @param \OpenAPI\Client\Model\ApplicationServerInfoSyncStatusData[]|null $sync_status sync_status
     *
     * @return self
     */
