 ...
 */
class StoreBaseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreBaseData';
    ...
    */
    ...
    public function setPaymentTolerance($payment_tolerance)
    {
        ...
        if (($payment_tolerance > 100.0)) {
            throw new \InvalidArgumentException('invalid value for $payment_tolerance when calling StoreBaseData., must be smaller than or equal to 100.0.');
        }
        if (($payment_tolerance < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $payment_tolerance when calling StoreBaseData., must be bigger than or equal to 0.0.');
        }
