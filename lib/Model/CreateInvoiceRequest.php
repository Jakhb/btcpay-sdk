...
class CreateInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'additional_search_terms' => 'setAdditionalSearchTerms'
    ];
    ...
    protected static $getters = [
        ...
        'additional_search_terms' => 'getAdditionalSearchTerms'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('additional_search_terms', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The amount of the invoice. If null or unspecified, the invoice will be a top-up invoice. (ie. The invoice will consider any payment as a full payment)
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the invoice (if null, empty or unspecified, the currency will be the store's settings default)'
     *
     * @return self
     */
    ...
    /**
     * Gets additional_search_terms
     *
     * @return string[]|null
     */
    public function getAdditionalSearchTerms()
    {
        return $this->container['additional_search_terms'];
    }

    /**
     * Sets additional_search_terms
     *
     * @param string[]|null $additional_search_terms Additional search term to help you find this invoice via text search
     *
     * @return self
     */
    public function setAdditionalSearchTerms($additional_search_terms)
    {
        if (is_null($additional_search_terms)) {
            array_push($this->openAPINullablesSetToNull, 'additional_search_terms');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('additional_search_terms', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['additional_search_terms'] = $additional_search_terms;
