 ...
 */
class OnChainWalletOverviewData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnChainWalletOverviewData';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unconfirmed_balance', $data ?? [], null);
    ...
    */
     ...
     * Sets balance
     *
     * @param float|null $balance The total current balance of the wallet
     *
     * @return self
     */
     ...
     *
     * @param float|null $unconfirmed_balance The current unconfirmed balance of the wallet
     *
     * @return self
     */
    public function setUnconfirmedBalance($unconfirmed_balance)
    {
        if (is_null($unconfirmed_balance)) {
            throw new \InvalidArgumentException('non-nullable unconfirmed_balance cannot be null');
        }
     ...
     *
     * @param float|null $confirmed_balance The current confirmed balance of the wallet
     *
     * @return self
     */
