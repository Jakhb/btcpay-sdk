...
/**
 * PayoutProcessorData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayoutProcessorData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutProcessorData';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name unique identifier of the payout processor
     *
     * @return self
     */
     ...
     * Sets friendly_name
     *
     * @param string|null $friendly_name Human name of the payout processor
     *
     * @return self
     */
     ...
     * Sets payout_methods
     *
     * @param string[]|null $payout_methods Supported, payment methods by this processor
     *
     * @return self
     */
